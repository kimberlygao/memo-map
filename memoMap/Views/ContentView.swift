    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                if showingPrompt {
                    PromptMapWrapper(memoryController: memoryController, mapViewController: mapViewController, searchController: searchController, userController: userController, findUser: self.$findUser)
                } else {
